...
// 	$usuario = stripslashes($usuario);
	...
	require 'conexiondb.php';
		...
		$statement = $conexion->prepare('SELECT * FROM users WHERE usuario = :usuario LIMIT 1');
	...
	if ($errores == '') {
		$statement = $conexion->prepare('INSERT INTO users (id, usuario, pass) VALUES (null, :usuario, :pass)');
